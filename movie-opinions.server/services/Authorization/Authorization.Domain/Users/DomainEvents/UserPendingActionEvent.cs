...
{
    public sealed class UserPendingActionEvent : DomainEvent
    {
        ...
        public UserPendingActionEvent(UserPendingActionId userPendingActionId, Login login, UserAction userAction, DateTimeOffset expiresAt, DateTimeOffset now)
            : base(now)
        {
